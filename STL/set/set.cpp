...
// set-> unique & sorted elements which cannot be modified. Only can be removed or added.
//e.g. List of BT mac addresses used in searchin nearby devices : Uniuqe addresses and sorted keys/names
void printSet(const std::set<std::string>& setData)
{
    std::cout<<"----------------------------\n";
...
int main()
{
    std::set<std::string> mUniqueData;
